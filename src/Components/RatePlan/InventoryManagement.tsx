...
//     active: true,
//     isExpanded: true,
//     ratePlans: [{ id: 'cp', name: 'CP', type: 'Base Rate' }]
//   },
//   {
//     id: 2,
...
//     active: true,
//     isExpanded: false,
//     ratePlans: [{ id: 'exec-cp', name: 'CP', type: 'Base Rate' }]
//   },
//   {
//     id: 3,
...
//     active: true,
//     isExpanded: false,
//     ratePlans: [{ id: 'twin-cp', name: 'CP', type: 'Base Rate' }]
//   }
// ]);
...
//                             room.isExpanded ? 'chevron-expanded' : ''
//                           }`} />
...
//                     {/* Rate Plans */}
//                     {room.isExpanded && room.ratePlans.map((ratePlan) => (
...
//                               <input
//                                 type="number"
//                                 value={getRateValue(room.id, ratePlan.id, dayIndex, 'twoPersonRate')}
//                                 onChange={(e) => updateRate(room.id, ratePlan.id, dayIndex, 'twoPersonRate', parseInt(e.target.value) || 0)}
...
//                               <input
//                                 type="number"
//                                 value={getRateValue(room.id, ratePlan.id, dayIndex, 'onePersonRate')}
//                                 onChange={(e) => updateRate(room.id, ratePlan.id, dayIndex, 'onePersonRate', parseInt(e.target.value) || 0)}
//                                 className="rate-input"
//                                 min="0"
//                                 placeholder="0"
//                               />
...
//                           >
//                             <Plus className="icon" />
//                             <span className="show-rates-text">Show {room.name} rates</span>
//                           </button>
//                         </td>
//                         {weekDays.map((day, dayIndex) => {
//                           const roomData = getRoomData(room.id);
